      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between">
          <div className="flex space-x-7">
            ...
            <Link href="./" className="flex items-center py-4 px-2">
              <img src="/image/logo.png" alt="logo.png" width={80} height={80}/>
                <div>
                  <span className="font-semibold text-blue-700 text-lg">Tech Meets Trend</span>
                  <p className="text-xs text-gray-400">Speed, Style, and Smart Features – Laptops That Do More</p>
                </div>
              </Link>
            </div>
          </div>
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link href="/gallery" className="py-4 px-2 text-gray-500 font-semibold hover:text-blue-500 transition duration-300">Gallery</Link>
